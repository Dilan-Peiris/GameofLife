...
def update(screens,cells,size,with_progress=False):
    ...
    for row, col in np.ndindex(cells.shape):
        ...
        pygame.draw.rect(screens,colour,(col * size, row * size, size -1 , size -1))
...
def main():
    ...
    screens.fill(COLOUR_GRID)
    update(screens,cells,10)
    ...
    while True:
        ...
        if running:
            cells = update(screens,cells,10,with_progress=True)
            pygame.display.update()
